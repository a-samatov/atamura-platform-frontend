  ...
  <div>
    ...
    <section class="page-header section--dark">
      <div class="container page-header__inner">
        <AppBreadcrumb :items="[{ label: 'Басты бет', href: '/kz' }, { label: 'Жобалар' }]" />
        <h1 class="page-header__title">Тұрғын үй кешендері</h1>
        <p class="page-header__sub">Авторлық сәулетпен және дамыған инфрақұрылыммен бизнес-класс</p>
      </div>
    </section>
    ...
    <section class="section jk-section" aria-labelledby="jk-heading">
      <div class="container">
        <div class="jk-grid">
          ...
          >
            <NuxtLink :to="`/kz/jk/${jk.slug}`" class="jk-card__link">
              <div class="jk-card__img-wrapper">
                <img
                  :src="jk.img"
                  :alt="`ЖК ${jk.name} — Алматыдағы тұрғын үй кешені`"
                  loading="lazy"
                  class="jk-card__img"
                  itemprop="image"
                />
        ...
        <div v-if="filteredProjects.length === 0" class="jk-empty">
          <p>Таңдалған санатта жобалар жоқ</p>
        </div>
      </div>
    </section>
    ...
    <section class="section section--brand projects-cta-section">
      <div class="container">
        <div class="projects-cta reveal">
          <h2 class="projects-cta__title">Сізге сәйкес пәтер табайық</h2>
          <p class="projects-cta__desc">Менеджеріміз барлық жобалар бойынша кеңес береді және ең қолайлы нұсқаны ұсынады</p>
          <div class="projects-cta__actions">
            <AppButton size="lg" @click="uiStore.openModal('application')">Кеңеске жазылу</AppButton>
          </div>
        </div>
      </div>
    </section>
...
useSeoMeta({
  title: 'Жобалар | Atamura Group',
  description: 'Atamura Group тұрғын үй кешендері — Алматыдағы бизнес-класс жобалар. Атмосфера, Keruen, Aqsai Resort. Авторлық сәулет, жабық аумақ, панорамалық көрініс.',
})

useHead({
  htmlAttrs: { lang: 'kk' },
  link: [{ rel: 'canonical', href: `${siteUrl}/kz/projects` }],
})
...
const filters = [
  ...
  { label: 'Салынуда', value: 'under-construction' },
  { label: 'Тапсырылды', value: 'completed' },
]
...
const projects = [
  {
    ...
    meta: 'Алматы · Бизнес-класс · 2026 жыл IV тоқсан',
    desc: 'Авторлық сәулетпен, жабық аумақпен және Алматы тауларына панорамалық көрінісімен тұрғын үй кешені',
    tags: ['Панорамалық көрініс', 'Жабық аумақ'],
  },
  {
    slug: 'keruen',
    name: 'Keruen',
    ...
    statusType: 'under-construction',
    meta: 'Алматы · Бизнес-класс · 2026 жыл IV тоқсан',
    desc: 'Максималды жайлылық пен қауіпсіздікті қамтамасыз ететін озық сәулеттік шешімдермен жобаланған заманауи тұрғын үй кешені',
    tags: ['Панорамалық көрініс', 'Жабық аумақ'],
  },
  {
    slug: 'aqsai',
    ...
    statusType: 'under-construction',
    meta: 'Алматы · Бизнес-класс · 2026 жыл IV тоқсан',
    desc: 'Алматының тау бөктеріндегі толық инфрақұрылымы және орталық бульвары бар заманауи аз қабатты шағын аудан',
...
/* ─── JK section (точная копия из index.vue) ──────────────────── */
