...
const c = useHomeContent('kk')

useSeoMeta({
  title: 'Atamura Group — Алматыдағы тұрғын үй кешендері',
  description: 'Atamura Group — Алматыдағы бизнес-класс тұрғын үй кешендері. ЖК Атмосфера — дамыған инфрақұрылыммен заманауи тұрғын үй. Ипотека, бөліп төлеу.',
  ogTitle: 'Atamura Group — Алматыдағы тұрғын үй кешендері',
  ogDescription: 'Алматыдағы бизнес-класс тұрғын үй кешендері. Ашық мерзімдер, сапалы құрылыс.',
