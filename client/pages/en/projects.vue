  ...
  <div>
    ...
    <section class="page-header section--dark">
      <div class="container page-header__inner">
        <AppBreadcrumb :items="[{ label: 'Home', href: '/en' }, { label: 'Projects' }]" />
        <h1 class="page-header__title">Residential Complexes</h1>
        <p class="page-header__sub">Business class with signature architecture and developed infrastructure</p>
      </div>
    </section>
    ...
    <section class="section jk-section" aria-labelledby="jk-heading">
      <div class="container">
        <div class="jk-grid">
          ...
          >
            <NuxtLink :to="`/en/jk/${jk.slug}`" class="jk-card__link">
              <div class="jk-card__img-wrapper">
                <img
                  :src="jk.img"
                  :alt="`${jk.name} — residential complex in Almaty`"
                  loading="lazy"
                  class="jk-card__img"
                  itemprop="image"
                />
    ...
    <section class="section section--brand projects-cta-section">
      <div class="container">
        <div class="projects-cta reveal">
          <h2 class="projects-cta__title">Let us find the right apartment for you</h2>
          <p class="projects-cta__desc">Our manager will advise you on all projects and suggest the most suitable option</p>
...
useSeoMeta({
  title: 'Projects | Atamura Group',
  description: 'Atamura Group residential complexes — business-class projects in Almaty. Atmosfera, Keruen, Aqsai Resort. Signature architecture, secured grounds, panoramic views.',
})

useHead({
  htmlAttrs: { lang: 'en' },
  link: [{ rel: 'canonical', href: `${siteUrl}/en/projects` }],
})
...
const projects = [
  {
    ...
    meta: 'Almaty · Business Class · Q4 2026 delivery',
    desc: 'A residential complex with signature architecture, secured grounds and panoramic views of the Almaty mountains',
    tags: ['Panoramic views', 'Secured grounds'],
  },
  {
    slug: 'keruen',
    name: 'Keruen',
    ...
    statusType: 'under-construction',
    meta: 'Almaty · Business Class · Q4 2026 delivery',
    desc: 'A modern residential complex designed with cutting-edge architectural solutions for maximum comfort and safety',
    tags: ['Panoramic views', 'Secured grounds'],
  },
  {
    slug: 'aqsai',
    ...
    statusType: 'under-construction',
    meta: 'Almaty · Business Class · Q4 2026 delivery',
    desc: 'A modern low-rise microdistrict in the foothills of Almaty with full infrastructure and a central boulevard',
    tags: ['Parking', 'Secured grounds'],
  },
]
