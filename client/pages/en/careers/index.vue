  ...
  <div>
    <section class="page-header section--dark">
      <div class="container page-header__inner">
        <AppBreadcrumb :items="[{ label: 'Home', href: '/en' }, { label: 'Careers' }]" />
        <h1 class="page-header__title">Careers at Atamura Group</h1>
        <p class="page-header__sub">Join the team that builds quality homes</p>
      </div>
    </section>
    ...
    <section class="section section--light">
      <div class="container">
        ...
        <h2 class="section-title">Working at Atamura Group</h2>
    ...
    <section class="section section--brand">
      <div class="container cta-row">
        <div>
          <h2 class="section-title">Didn't find the right role?</h2>
          <p style="margin-top: var(--space-3); color: var(--color-gray-600);">Send us your CV — we'll consider it when a matching position opens up</p>
        </div>
        <a href="mailto:hr@atamuragroup.kz">
          <AppButton size="lg">Send Your CV</AppButton>
        </a>
      </div>
    </section>
  </div>
...
useSeoMeta({
  title: 'Careers | Atamura Group',
  description: 'Job openings at Atamura Group — a construction company in Almaty. Join a team of professionals.',
})

useHead({
  htmlAttrs: { lang: 'en' },
  link: [
    { rel: 'canonical', href: `${siteUrl}/en/careers` },
...
const { data: jobs } = await useAsyncData<Job[]>('jobs-en',
...
const formatSalary = (job: Job) => {
  ...
  if (job.salary_from) return `from ${job.salary_from.toLocaleString()} ${currency}`
  if (job.salary_to) return `up to ${job.salary_to.toLocaleString()} ${currency}`
  return ''
}

const perks = [
  { title: 'Competitive Salary', desc: 'Transparent pay structure with quarterly performance bonuses.', icon: `<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>` },
  { title: 'Official Employment', desc: 'Full compliance with Kazakhstan labour law, health insurance, paid leave.', icon: `<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>` },
  { title: 'Growth', desc: 'Corporate training programmes and paid professional courses.', icon: `<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"/><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"/></svg>` },
  { title: 'Great Team', desc: 'Young staff, corporate events, and an open, friendly culture.', icon: `<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>` },
]
</script>
