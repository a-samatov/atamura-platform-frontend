<template>
  <div class="jk-page">
    <!-- ─── Hero ────────────────────────────────────────────── -->
    <section class="jk-hero" aria-label="Atmosfera — main banner">
      <div class="container jk-hero__container">
        <div class="jk-hero__content fade-in">
          ...
          <div class="jk-hero__badge">
            ...
            Under Construction · Q4&nbsp;2026 Delivery
          </div>
          <h1 class="jk-hero__title">
            <span class="jk-hero__accent">Atmosfera</span>
          </h1>
          <p class="jk-hero__sub">Business-class residential complex in Almaty</p>
        ...
        <div class="jk-hero__visual">
          <div class="jk-hero__img-frame">
            <img
              ...
              alt="Atmosfera — business-class residential complex in Almaty"
              class="jk-hero__img"
              fetchpriority="high"
              loading="eager"
            />
      ...
      <div class="container">
        <div class="about-project__grid">
          <div class="about-project__text reveal-left">
            ...
            <h2 id="about-heading" class="section-title">Thoughtfully designed living for those who value quality</h2>
            <p class="about-project__desc">
              Atmosfera is a 5-storey residential complex with 114 apartments in Almaty.
              Signature architecture, a secured landscaped territory, underground parking,
              and panoramic views of the Zailiysky Alatau mountains.
            </p>
            <p class="about-project__desc">
              Every apartment is designed with maximum natural light and functional layout in mind.
              Turnkey finishing available on request.
            </p>
          </div>
    ...
    <section class="section section--light advantages-section" aria-labelledby="adv-heading">
      <div class="container">
        <p class="section-label">Why Atmosfera</p>
        <h2 id="adv-heading" class="section-title reveal">Complex Advantages</h2>
    ...
    <section id="plans" class="section plans-section" aria-labelledby="plans-heading">
      <div class="container">
        <p class="section-label">Apartments</p>
        <h2 id="plans-heading" class="section-title reveal">Floor Plans</h2>
        <p class="plans-section__note reveal reveal-delay-1">Choose a layout — our manager will contact you with detailed information</p>

        <div class="plans-tabs reveal reveal-delay-2" role="tablist" aria-label="Floor plan types">
          <button
        ...
        <div class="plans-grid">
          ...
          >
            <div class="plan-card__img-wrapper">
              <img
                :src="plan.imageUrl"
                :alt="`${plan.type} floor plan, ${plan.area} m²`"
                loading="lazy"
            ...
            <div class="plan-card__info">
              ...
              <p class="plan-card__area">{{ plan.area }} m²</p>
              <AppButton
                variant="outline"
                size="sm"
                @click="uiStore.openModal('plan', { jkSlug: 'atmosfera', planName: `${plan.type}, ${plan.area} m²` })"
              >
                Select this plan
              </AppButton>
            </div>
    ...
    <section class="section section--light infra-section" aria-labelledby="infra-heading">
      <div class="container">
        ...
        <h2 id="infra-heading" class="section-title reveal">District Infrastructure</h2>
        <div class="infra-content">
          ...
          <div class="infra-map reveal-right">
            <ClientOnly>
              <YandexMap
                :markers="[{ lat: 43.328407, lng: 77.019172, title: 'Atmosfera', description: 'Almaty, Nurshashkan dist., Alatau St.' }]"
    ...
    <section v-if="progressPhotos && progressPhotos.length" class="section" aria-labelledby="progress-heading" style="border-bottom: 1px solid #dcdcdc;">
      <div class="container">
        ...
        <h2 id="progress-heading" class="section-title reveal">Construction Progress</h2>
        ...
        <div v-if="progressPhotos.length > photosPerPage" class="progress-photos__more">
          <button class="progress-photos__more-btn" @click="photosExpanded = !photosExpanded">
            <span>{{ photosExpanded ? 'Collapse' : `View all photos (${progressPhotos.length})` }}</span>
            <svg
    ...
    <section v-if="videos && videos.length" class="section section--light" aria-labelledby="videos-heading" style="background: white; border-bottom: 1px solid #dcdcdc;">
      <div class="container">
        <p class="section-label">In Detail</p>
        <h2 id="videos-heading" class="section-title reveal">Video Reports</h2>
      ...
      <div class="container">
        <div class="docs-section">
          <div class="reveal-left">
            ...
            <p class="section-desc">Construction permit and project declaration</p>
          </div>
    ...
    <section class="section section--brand mortgage-section" aria-labelledby="mortgage-heading">
      <div class="container mortgage-section__inner">
        <div class="reveal-left">
          <p class="section-label">Affordability</p>
          <h2 id="mortgage-heading" class="section-title">Mortgage & Instalment</h2>
          <p class="section-desc">We work with Kazakhstan's leading banks. Down payment from 20%.</p>
    ...
    <section v-if="reviews && reviews.length" class="section" aria-labelledby="reviews-heading">
      <div class="container">
        <p class="section-label">Residents' Opinions</p>
        <h2 id="reviews-heading" class="section-title reveal">Reviews of Atmosfera</h2>
    ...
    <section class="section section--light" aria-labelledby="other-jk-heading">
      <div class="container">
        ...
        <h2 id="other-jk-heading" class="section-title reveal">Our Complexes</h2>
        <div class="other-jk">
          <div class="other-jk-card reveal-scale reveal-delay-1">
            <p class="other-jk-card__name">Keruen</p>
            <p class="other-jk-card__desc">Business-class residential complex · 24 floors · Q4 2026 delivery</p>
            <NuxtLink to="/en/jk/keruen"><AppButton variant="outline" size="sm">Learn More</AppButton></NuxtLink>
          </div>
          <div class="other-jk-card reveal-scale reveal-delay-2">
            <p class="other-jk-card__name">Aqsai Resort</p>
            <p class="other-jk-card__desc">Townhouses & houses · Gated community · Natural atmosphere</p>
            <NuxtLink to="/en/jk/aqsai"><AppButton variant="outline" size="sm">Learn More</AppButton></NuxtLink>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="contact-section__inner">
          <div class="contact-section__text reveal-left">
            ...
            <h2 id="contact-heading" class="section-title">Leave a Request</h2>
            <p class="section-desc">A manager will contact you within an hour and answer all your questions</p>
          ...
          <div class="contact-section__form reveal-right">
            <EnApplicationForm jk-slug="atmosfera" />
          </div>
        </div>
      </div>
    </section>
...
useSeoMeta({
  title: 'Atmosfera — Apartments in Almaty | Atamura Group',
  description: 'Atmosfera — a business-class residential complex in Almaty. 5 floors, 114 apartments, underground parking, secured territory. Mortgage from leading banks.',
  ogTitle: 'Atmosfera in Almaty | Atamura Group',
  ogDescription: 'Business-class residential complex. Apartments from studio to 3-room. Q4 2026 delivery.',
...
useHead({
  htmlAttrs: { lang: 'en' },
  link: [
    { rel: 'canonical', href: `${siteUrl}/en/jk/atmosfera` },
...
// Calculate how many columns fit in the minmax(280px, 1fr) grid,
// then show 2 rows × number of columns
...
const breadcrumbs = [
  { label: 'Home', href: '/' },
  { label: 'Our Complexes', href: '/#projects' },
  { label: 'Atmosfera' },
]

const specs = [
  { value: '5', label: 'floors' },
  { value: '114', label: 'apartments' },
  { value: 'Q4 2026', label: 'completion' },
  { value: '2', label: 'parking levels' },
]

const jkMarkers = [
  { lat: 43.255340, lng: 76.957853, title: 'Sales Office on Tole bi', description: 'Almaty, Tole bi St., 12' },
  { lat: 43.328407, lng: 77.019172, title: 'Sales Office at Atmosfera', description: 'Almaty, Nurshashkan dist., Alatau St.' },
  { lat: 43.182382, lng: 76.816449, title: 'Sales Office on Zhandosova', description: 'Zhandosova St. 54 (UKO House BC)' },
  { lat: 43.364445, lng: 77.124499, title: 'Aura Sales Office', description: 'Tuzusai village, Talgar district, Syrymdatuly St., 100a' },
  { lat: 43.429439, lng: 77.025712, title: 'Bravo Sales Office', description: 'Otecen Batyr village, Zhansugurova St. 109' },
  { lat: 43.392038, lng: 77.024813, title: 'Discovery RC Sales Office', description: 'Almaty region, Talgar district, Zhana Kuat dist.' },
]

const advantages = [
  {
    title: 'Secured Territory',
    desc: '24/7 CCTV, access control, guarded entrance for residents',
  ...
  },
  {
    ...
    desc: 'Two-level parking with ramps, elevators, and ventilation system',
  ...
  },
  {
    ...
    desc: 'Façade designed by Kazakhstan\'s leading architectural bureau. Panoramic glazing',
  ...
  },
  {
    ...
    desc: 'Upper floors offer stunning views of the Zailiysky Alatau mountains',
  ...
  },
  {
    ...
    desc: 'Modern play complex and sports area within the secured grounds',
  ...
  },
  {
    ...
    desc: 'Otis elevators, finishing materials from leading European manufacturers',
...
const plans = [
  { id: '2k-1', type: '2-room', area: 68, typeId: '2k', imageUrl: '/images/atmosfera/plans/2kom68.webp' },
  { id: '2k-2', type: '2-room', area: 70, typeId: '2k', imageUrl: '/images/atmosfera/plans/2kom70.webp' },
  { id: '3k-1', type: '3-room', area: 78, typeId: '3k', imageUrl: '/images/atmosfera/plans/3kom78.webp' },
  { id: '3k-2', type: '3-room', area: 81, typeId: '3k', imageUrl: '/images/atmosfera/plans/3kom81.webp' },
  { id: '3k-3', type: '3-room', area: 82, typeId: '3k', imageUrl: '/images/atmosfera/plans/3kom82.png' },
]
...
const infrastructure = [
  { label: 'School', value: '5 min walk', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>` },
  { label: 'Kindergarten', value: '3 min walk', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>` },
  { label: 'Supermarket', value: '2 min walk', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"/></svg>` },
  { label: 'Park', value: '7 min walk', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M17 8C8 10 5.9 16.17 3.82 22 9 18 14 18 17 8z"/><path d="M7 8C16 10 18.1 16.17 20.18 22 15 18 10 18 7 8z"/></svg>` },
  { label: 'Bus Stop', value: '1 min walk', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>` },
]
...
const [progressPhotos, videos, reviews, documents] = await Promise.all([
  ...
  useOptionalApi<Review[]>('/api/reviews?jk=atmosfera&lang=en'),
