<template>
  <div class="jk-page">
    <!-- ─── Hero ────────────────────────────────────────────── -->
    <section class="jk-hero" aria-label="ЖК Атмосфера — главный баннер">
      <div class="container jk-hero__container">
        <div class="jk-hero__content fade-in">
          ...
          <div class="jk-hero__badge">
            ...
            Строится · Сдача IV&nbsp;кв. 2026
          </div>
          <h1 class="jk-hero__title">
            ЖК <span class="jk-hero__accent">Атмосфера</span>
          </h1>
          <p class="jk-hero__sub">Жилой комплекс бизнес-класса в Алматы</p>
        ...
        <div class="jk-hero__visual">
          <div class="jk-hero__img-frame">
            <img
              ...
              alt="ЖК Атмосфера — жилой комплекс бизнес-класса в Алматы"
              class="jk-hero__img"
              fetchpriority="high"
              loading="eager"
            />
      ...
      <div class="container">
        <div class="about-project__grid">
          <div class="about-project__text reveal-left">
            ...
            <h2 id="about-heading" class="section-title">Продуманное жильё для тех, кто ценит качество</h2>
            <p class="about-project__desc">
              ЖК Атмосфера — это 5 этажный жилой комплекс с 114 квартирами в Алматы.
              Авторская архитектура, закрытая благоустроенная территория, подземный паркинг
              и панорамные виды на горы Заилийского Алатау.
            </p>
            <p class="about-project__desc">
              Каждая квартира спроектирована с учётом максимального естественного освещения
              и функциональной планировки. Чистовая отделка под ключ — по желанию.
            </p>
          </div>
    ...
    <section class="section section--light advantages-section" aria-labelledby="adv-heading">
      <div class="container">
        <p class="section-label">Почему Атмосфера</p>
        <h2 id="adv-heading" class="section-title reveal">Преимущества комплекса</h2>
    ...
    <section id="plans" class="section plans-section" aria-labelledby="plans-heading">
      <div class="container">
        <p class="section-label">Квартиры</p>
        <h2 id="plans-heading" class="section-title reveal">Планировки</h2>
        <p class="plans-section__note reveal reveal-delay-1">Выберите подходящую планировку — менеджер свяжется с вами с подробной информацией</p>

        <div class="plans-tabs reveal reveal-delay-2" role="tablist" aria-label="Типы планировок">
          <button
    ...
    <section class="section section--light infra-section" aria-labelledby="infra-heading">
      <div class="container">
        <p class="section-label">Расположение</p>
        <h2 id="infra-heading" class="section-title reveal">Инфраструктура района</h2>
        <div class="infra-content">
          ...
          <div class="infra-map reveal-right">
            <ClientOnly>
              <YandexMap
                :markers="[{ lat: 43.328407, lng: 77.019172, title: 'ЖК Атмосфера', description: 'г. Алматы, мкр. Нуршашкан, ул. Алатау' }]"
    ...
    <section v-if="progressPhotos && progressPhotos.length" class="section" aria-labelledby="progress-heading" style="border-bottom: 1px solid #dcdcdc;">
      <div class="container">
        <p class="section-label">Прозрачность</p>
        <h2 id="progress-heading" class="section-title reveal">Ход строительства</h2>
        ...
        <div v-if="progressPhotos.length > photosPerPage" class="progress-photos__more">
          <button class="progress-photos__more-btn" @click="photosExpanded = !photosExpanded">
            <span>{{ photosExpanded ? 'Свернуть' : `Смотреть все фото (${progressPhotos.length})` }}</span>
            <svg
    ...
    <section v-if="videos && videos.length" class="section section--light" aria-labelledby="videos-heading" style="background: white; border-bottom: 1px solid #dcdcdc;">
      <div class="container">
        <p class="section-label">Объект в деталях</p>
        <h2 id="videos-heading" class="section-title reveal">Видеоотчёты</h2>
      ...
      <div class="container">
        <div class="docs-section">
          <div class="reveal-left">
            ...
            <h2 id="docs-heading" class="section-title">Документы</h2>
            <p class="section-desc">Разрешение на строительство и проектная декларация</p>
          </div>
    ...
    <section class="section section--brand mortgage-section" aria-labelledby="mortgage-heading">
      <div class="container mortgage-section__inner">
        <div class="reveal-left">
          <p class="section-label">Доступность</p>
          <h2 id="mortgage-heading" class="section-title">Ипотека и рассрочка</h2>
          <p class="section-desc">Работаем с ведущими банками Казахстана. Первоначальный взнос от 20%.</p>
    ...
    <section v-if="reviews && reviews.length" class="section" aria-labelledby="reviews-heading">
      <div class="container">
        <p class="section-label">Мнения жителей</p>
        <h2 id="reviews-heading" class="section-title reveal">Отзывы о ЖК Атмосфера</h2>
    ...
    <section class="section section--light" aria-labelledby="other-jk-heading">
      <div class="container">
        <p class="section-label">Другие проекты</p>
        <h2 id="other-jk-heading" class="section-title reveal">Наши ЖК</h2>
        <div class="other-jk">
          <div class="other-jk-card reveal-scale reveal-delay-1">
            <p class="other-jk-card__name">ЖК Keruen</p>
            <p class="other-jk-card__desc">Жилой комплекс бизнес-класса · 24 этажа · Сдача IV кв. 2026</p>
            <NuxtLink to="/jk/keruen"><AppButton variant="outline" size="sm">Подробнее</AppButton></NuxtLink>
          </div>
          <div class="other-jk-card reveal-scale reveal-delay-2">
            <p class="other-jk-card__name">Aqsai Resort</p>
            <p class="other-jk-card__desc">Таунхаусы и дома · Закрытый посёлок · Природная атмосфера</p>
            <NuxtLink to="/jk/aqsai"><AppButton variant="outline" size="sm">Подробнее</AppButton></NuxtLink>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="contact-section__inner">
          <div class="contact-section__text reveal-left">
            <p class="section-label">Связаться с нами</p>
            <h2 id="contact-heading" class="section-title">Оставить заявку</h2>
            <p class="section-desc">Менеджер свяжется с вами в течение часа и ответит на все вопросы</p>
          ...
          <div class="contact-section__form reveal-right">
            <FormsApplicationForm jk-slug="atmosfera" />
          </div>
        </div>
      </div>
    </section>
...
useSeoMeta({
  title: 'ЖК Атмосфера — квартиры в Алматы | Atamura Group',
  description: 'ЖК Атмосфера — жилой комплекс бизнес-класса в Алматы. 5 этажа, 114 квартир, подземный паркинг, закрытая территория. Ипотека от ведущих банков.',
  ogTitle: 'ЖК Атмосфера в Алматы | Atamura Group',
  ogDescription: 'Жилой комплекс бизнес-класса. Квартиры от студии до 3-комнатных. Сдача IV кв. 2026.',
...
useHead({
  htmlAttrs: { lang: 'ru' },
  link: [
    { rel: 'canonical', href: `${siteUrl}/jk/atmosfera` },
...
function openLightbox(index: number) {
  // visiblePhotos — срез от начала, поэтому индекс совпадает с полным массивом
...
const breadcrumbs = [
  { label: 'Главная', href: '/' },
  { label: 'Наши ЖК', href: '/#projects' },
  { label: 'ЖК Атмосфера' },
]

const specs = [
  { value: '5', label: 'этажа' },
  { value: '114', label: 'квартир' },
  { value: 'IV 2026', label: 'срок сдачи' },
...
const jkMarkers = [
  ...
  { lat: 43.328407, lng: 77.019172, title: 'Отдел продаж в ЖК Атмосфера', description: 'г. Алматы, мкр. Нуршашкан, ул. Алатау' },
  { lat: 43.182382, lng: 76.816449, title: 'Отдел продаж на Жандосова', description: 'Ул. Жандосова 54 (БЦ UKO House)' },
  { lat: 43.364445, lng: 77.124499, title: 'Отдел продаж Аура', description: 'с. Тузусай, Талгарский район, ул. Сырым Датулы, 100а' },
  { lat: 43.429439, lng: 77.025712, title: 'Отдел продаж Bravo', description: 'п. Отечен Батыр, ул. Жансугурова 109' },
  { lat: 43.392038, lng: 77.024813, title: 'Отдел продаж ЖК Discovery', description: 'Алматинская область, Талгарский район, мкр. Жана Куат' },
]
const advantages = [
  {
    title: 'Закрытая территория',
    desc: 'Видеонаблюдение 24/7, контроль доступа, охраняемый въезд для жителей',
  ...
  },
  {
    ...
    desc: 'Два уровня паркинга с пандусами, лифтами и системой вентиляции',
  ...
  },
  {
    ...
    desc: 'Фасад разработан ведущим архитектурным бюро Казахстана. Панорамное остекление',
  ...
  },
  {
    ...
    desc: 'С верхних этажей открываются виды на горы Заилийского Алатау',
  ...
  },
  {
    ...
    desc: 'Современный игровой комплекс и зона для занятий спортом на закрытой территории',
  ...
  },
  {
    ...
    desc: 'Лифты Otis, отделочные материалы ведущих европейских производителей',
...
const plans = [
  { id: '2k-1', type: '2-комнатная', area: 68, typeId: '2k', imageUrl: '/images/atmosfera/plans/2kom68.webp' },
  { id: '2k-2', type: '2-комнатная', area: 70, typeId: '2k', imageUrl: '/images/atmosfera/plans/2kom70.webp' },
  { id: '3k-1', type: '3-комнатная', area: 78, typeId: '3k', imageUrl: '/images/atmosfera/plans/3kom78.webp' },
  { id: '3k-2', type: '3-комнатная', area: 81, typeId: '3k', imageUrl: '/images/atmosfera/plans/3kom81.webp' },
  { id: '3k-3', type: '3-комнатная', area: 82, typeId: '3k', imageUrl: '/images/atmosfera/plans/3kom82.png' },
]
...
const infrastructure = [
  { label: 'Школа', value: '5 мин пешком', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>` },
  { label: 'Детский сад', value: '3 мин пешком', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><circle cx="12" cy="8" r="7"/><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"/></svg>` },
  { label: 'Супермаркет', value: '2 мин пешком', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6"/></svg>` },
  { label: 'Парк', value: '7 мин пешком', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><path d="M17 8C8 10 5.9 16.17 3.82 22 9 18 14 18 17 8z"/><path d="M7 8C16 10 18.1 16.17 20.18 22 15 18 10 18 7 8z"/></svg>` },
  { label: 'Остановка', value: '1 мин пешком', icon: `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>` },
]
...
const [progressPhotos, videos, reviews, documents] = await Promise.all([
  ...
  useOptionalApi<Review[]>('/api/reviews?jk=atmosfera&lang=ru'),
