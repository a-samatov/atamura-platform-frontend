...
useSeoMeta({
  ...
  description: 'Фотоотчёты о ходе строительства ЖК Керуен в Алматы. Ежемесячные обновления.',
})

useHead({
  htmlAttrs: { lang: 'ru' },
  link: [{ rel: 'canonical', href: `${siteUrl}/jk/keruen/progress` }],
})

const breadcrumbs = [
  { label: 'Главная', href: '/' },
  { label: 'ЖК Керуен', href: '/jk/keruen' },
