  ...
  <div>
    ...
    <section class="page-header section--dark">
      <div class="container page-header__inner">
        <AppBreadcrumb :items="[{ label: 'Главная', href: '/' }, { label: 'О компании' }]" />
        <h1 class="page-header__title">О компании</h1>
        <p class="page-header__sub">Atamura Group — строительная компания с 14-летним опытом</p>
      </div>
    </section>
      ...
      <div class="container">
        <div class="about-grid">
          <div class="about-text reveal-left">
            <p class="section-label">Наша история</p>
            <h2 class="section-title">Строим с 2010 года</h2>
            <p>Atamura Group основана в 2010 году с единственной целью — создавать качественное жильё, в котором хочется жить. За 14 лет мы построили и сдали 8 жилых комплексов в Алматы.</p>
            <p>Наш принцип: ни одного срыва сроков, ни одной незакрытой гарантийной претензии. Мы строим на собственные и привлечённые средства без перекрёстного финансирования между проектами.</p>
          </div>
          <div class="about-img reveal-right">
            <img src="/images/atamura2.webp" alt="Команда Atamura Group" loading="lazy" />
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section section--light">
      <div class="container">
        <div class="section-intro reveal">
          <p class="section-label">Наши принципы</p>
          <h2 class="section-title" >Ценности компании</h2>
        </div>
    ...
    <section class="section timeline-section">
      <div class="container">
        <div class="section-intro reveal">
          <p class="section-label">История роста</p>
          <h2 class="section-title">Ключевые события</h2>
        </div>
        <div class="timeline">
    ...
    <section class="section section--light">
      <div class="container">
        <div class="section-intro reveal">
          <p class="section-label">Руководство</p>
    ...
    <section class="section">
      <div class="container">
        <div class="section-intro reveal">
          <p class="section-label">Признание</p>
          <h2 class="section-title">Награды и сертификаты</h2>
        </div>
    ...
    <section class="section section--brand about-cta-section">
      <div class="container">
        <div class="about-cta reveal">
          <h2 class="about-cta__title">Готовы узнать больше?</h2>
          <p class="about-cta__desc">Посетите наш офис или свяжитесь с менеджером — ответим на любые вопросы</p>
          <div class="about-cta__actions">
            <AppButton size="lg" @click="uiStore.openModal('application')">Записаться на консультацию</AppButton>
            <NuxtLink to="/contacts"><AppButton variant="outline" size="lg">Контакты</AppButton></NuxtLink>
          </div>
        </div>
      </div>
    </section>
...
useSeoMeta({
  title: 'О компании | Atamura Group',
  description: 'Atamura Group — строительная компания с 2010 года. 14 лет опыта, 8 сданных ЖК, более 1200 семей. Строим качественное жильё в Алматы.',
})
...
const achievements = [
  { num: '14', unit: 'лет', label: 'на рынке недвижимости' },
  { num: '8', unit: 'ЖК', label: 'построено и сдано' },
  { num: '1 200+', unit: 'семей', label: 'выбрали наши квартиры' },
  { num: '100', unit: '%', label: 'соблюдение сроков сдачи' },
]

const values = [
  { title: 'Надёжность', desc: 'Ни одного срыва сроков за 14 лет работы. Все обязательства перед дольщиками выполнены в срок.' },
  { title: 'Прозрачность', desc: 'Регулярные фото- и видеоотчёты о ходе строительства, открытые финансовые отчёты.' },
  { title: 'Качество', desc: 'Используем только сертифицированные материалы и технологии, прошедшие проверку временем.' },
  { title: 'Ответственность', desc: 'Гарантийное обслуживание каждого объекта. Устраняем любые недостатки за наш счёт.' },
]

const timeline = [
  { year: '2010', title: 'Основание компании', desc: 'Atamura Group основана в Алматы. Первый проект — жилой комплекс на 120 квартир.' },
  { year: '2013', title: 'Первый сданный объект', desc: 'Успешно завершён и сдан первый жилой комплекс. Все 120 семей получили ключи точно в срок.' },
  { year: '2016', title: 'Расширение портфеля', desc: 'Портфель вырос до 3 жилых комплексов. Запущена программа партнёрства с банками.' },
  { year: '2019', title: 'Бизнес-класс', desc: 'Выход в сегмент бизнес-класса. Запуск первого проекта с авторской архитектурой и закрытой территорией.' },
  { year: '2022', title: '1 000 семей', desc: 'Более 1 000 семей выбрали наши квартиры. 7 сданных жилых комплексов без единого срыва сроков.' },
  { year: '2024', title: 'ЖК Атмосфера', desc: 'Старт флагманского проекта ЖК Атмосфера — лучший объект в истории компании.' },
]

const team = [
  { name: 'Имя Фамилия', role: 'Генеральный директор', photo: '/images/team/ceo.png', bio: '20 лет в строительстве. Основал компанию с нуля и вырастил до лидера рынка Алматы.' },
  { name: 'Имя Фамилия', role: 'Технический директор', photo: '/images/team/cto.png', bio: 'Отвечает за качество строительства и контроль всех технических стандартов.' },
  { name: 'Имя Фамилия', role: 'Коммерческий директор', photo: '/images/team/cco.png', bio: 'Выстроила партнёрство с 5 банками и запустила ипотечную программу для покупателей.' },
]

const awards = [
  {
    year: '2023',
    title: 'Лучший застройщик Алматы',
    org: 'Гильдия риэлторов',
  ...
  },
  {
    ...
    org: 'Ассоциация застройщиков Казахстана',
