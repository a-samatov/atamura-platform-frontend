<template>
  <div class="app-form">
    <div class="app-form__header">
      <h2 class="app-form__title">Leave a Request</h2>
      <p class="app-form__subtitle">Our manager will contact you within an hour</p>
    </div>
    ...
    <div v-if="form.success.value" class="app-form__success" role="alert">
      ...
      <p class="app-form__success-title">Request Sent!</p>
      <p>Our manager will contact you within one hour.</p>
    </div>

    <form v-else @submit.prevent="handleSubmit" novalidate>
      <div class="app-form__fields">
        <div class="field">
          <label for="app-name-en">Your Name</label>
          <input
            id="app-name-en"
            v-model="name"
            type="text"
        ...
        <div class="field">
          <label for="app-phone-en">Phone Number</label>
          <input
  id="app-phone-en"
  :value="phone"
...
/>
        ...
        <div v-if="props.jkSlug !== undefined" class="field">
          <label for="app-jk-en">Residential Complex</label>
          <select id="app-jk-en" v-model="selectedJk">
...
const PHONE_ERRORS: Record<string, string> = {
  ...
  phone_too_short: 'Minimum 7 digits',
...
const jkOptions = [
  { slug: 'atmosfera', label: 'Atmosfera' },
]
