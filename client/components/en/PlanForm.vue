<template>
  <div class="app-form">
    <div class="app-form__header">
      <h2 class="app-form__title">Select Floor Plan</h2>
    ...
    <div v-if="form.success.value" class="app-form__success" role="alert">
      ...
      <p class="app-form__success-title">Request Accepted!</p>
      <p>Our manager will contact you within an hour with full details about your selected floor plan.</p>
    </div>

    <form v-else @submit.prevent="handleSubmit" novalidate>
      <div class="app-form__fields">
        <div class="field">
          <label for="plan-name-en">Your Name</label>
          <input id="plan-name-en" v-model="name" type="text" placeholder="John Smith" required autocomplete="given-name" />
        </div>
        <div class="field">
          <label for="plan-phone-en">Phone Number</label>
          <input
  id="plan-phone-en"
  :value="phone"
