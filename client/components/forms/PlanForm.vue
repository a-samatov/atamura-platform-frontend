<template>
  <div class="app-form">
    <div class="app-form__header">
      <h2 class="app-form__title">Выбрать планировку</h2>
    ...
    <div v-if="form.success.value" class="app-form__success" role="alert">
      ...
      <p class="app-form__success-title">Заявка принята!</p>
      <p>Менеджер свяжется с вами в течение часа и расскажет подробности о выбранной планировке.</p>
    </div>

    <form v-else @submit.prevent="handleSubmit" novalidate>
      <div class="app-form__fields">
        <div class="field">
          <label for="plan-name">Ваше имя</label>
          <input id="plan-name" v-model="name" type="text" placeholder="Асан Асанов" required autocomplete="given-name" />
        </div>
        <div class="field">
          <label for="plan-phone">Номер телефона</label>
          <input
  id="plan-phone"
  :value="phone"
